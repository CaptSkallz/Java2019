...
class NamornikCanvas extends Canvas {
	...
	public void paintCanvas() {
		...
		if (namornik.alive) { // ak sa este neutopil, nakresli obrazok namornika
			...
			gc.strokeOval(namornik.getXPixel(false), namornik.getYPixel(false), namornik.waves, namornik.waves);
			gc.strokeOval(namornik.getXPixel(false) - 5, namornik.getYPixel(false) -5, namornik.waves + 10, namornik.waves + 10);
			gc.strokeOval(namornik.getXPixel(false) - 10, namornik.getYPixel(false) - 10, namornik.waves + 20, namornik.waves +20);
			// TODO
